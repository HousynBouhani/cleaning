      ...
      <Row>
        ...
        <div className="info-text mt-5">
          <p>
            ...
            wir Sie ausführlich über den Umgang mit Ihren Daten. Verantwortliche
        ...
        <strong className="my-3 d-block">Cookies</strong>
        <p>
          Wie viele andere Webseiten verwenden wir auch so genannte „Cookies“.
          Cookies sind kleine Textdateien, die von einem Webseitenserver auf
          ...
          hergestellt. Natürlich können Sie unsere Website grundsätzlich auch
          ohne Cookies betrachten. Internet-Browser sind regelmäßig so
          eingestellt, dass sie Cookies akzeptieren. Sie können die Verwendung
        ...
        <strong className="my-3 d-block">SSL-Verschlüsselung</strong>
        <p>
        ...
        <strong className="my-3 d-block">Kontaktformular</strong>
        <p>
